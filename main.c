...
#define CACHE_HIT_THRESHOLD 800
...
//Sigue con la ejecucion normal del programa
...
//Codigo del ataque meltdown+flush&reload
...
int main() {
    ...
    uint8_t *secret = (uint8_t *)0xffffffffff000000;
